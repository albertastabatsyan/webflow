...
// All HTML originates from articles.ts (developer-controlled source), not from
// user input or external APIs. No sanitisation needed.
  ...
  return (
    ...
    >
      {parts.map((part, i) => {
        ...
        // Safe: content is from hardcoded articles.ts, not user input
        return (
